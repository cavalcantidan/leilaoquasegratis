      ...
      <TABLE cellSpacing=2 cellPadding=2 width="100%" border=0>
        ...
        <TABLE cellSpacing=2 cellPadding=1 width="100%" border=0>
          <TBODY>
            <TR> 
              <TD colSpan=2></TD>
              <TD class=a align=right colSpan=2 nowrap>* Campos Obrigatorios</TD>
            </TR>
            <TR> 
            ...
            <TR> 
              ...
              <TD width="331" noWrap class=a> <input name="charge" type="text" class="solidinput" value="<? echo $charge;?>" size="12" maxlength="4">&nbsp;<font class="a">&pound;</font></TD>
