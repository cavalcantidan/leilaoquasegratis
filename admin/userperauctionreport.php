...
<TABLE width="100%"  border=0 cellPadding=0 cellSpacing=10>
  <!--DWLayoutTable-->
    <TR> 
      <TD width="100%" class="H1">Leil&atilde;o por Usu&aacute;rio</TD>
    </TR>
  	<TR>
	...
	?>
          <TABLE width="100%" border=1 cellSpacing=0 class=t-a>
            <!--DWLayoutTable-->
              <TR class=th-a> 
				...
				<TD width="10%" nowrap="nowrap" align="center">Total de Usuarios</TD>
		...
		<?
			while($obj = mysql_fetch_object($ressel))
			{
				...
				$qry = "select * from bid_account where auction_id='".$obj->auctionID."' group by user_id";
				$rs = mysql_query($qry);
