...
<HTML><HEAD>
<META http-equiv=Content-Type content="text/html; charset=<?=$lng_characset;?>"><LINK 
...
<BODY bgColor=<?=$ADMIN_HEADER_BG_COLOR1?> leftMargin=0 topMargin=0 marginheight="0" marginwidth="0" onLoad="sClock('<?=date("H");?>','<?=date("i");?>','<?=date("s");?>');">
  ...
  <TR>
     <TD>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
            ...
            <TD width="80%" height="42"><font class="sitename">Bem Vindo ao 
          ...
          <TD class=w noWrap align=middle><? echo ucfirst(gmstrftime('%A, %d de %B de %Y'));?></TD>
          <TD noWrap align=middle width="1%"><IMG height=25 
            src="images/divdots.gif" width=3></TD>
          <TD class=w noWrap align=middle>Usu&aacute;rio Logado: <B><? echo $usuario_admin; ?></B></TD>
          <TD noWrap align=middle width="1%"><IMG height=25 
            src="images/divdots.gif" width=3></TD>
