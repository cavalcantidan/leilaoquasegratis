...
<title><? echo $ADMIN_MAIN_SITE_NAME." - Registration Report"; ?></title>
...
<TABLE width="100%"  border=0 cellPadding=0 cellSpacing=10>
  <!--DWLayoutTable-->
    <TR> 
      <TD width="100%" class="H1">Registration Ratio</TD>
    </TR>
  	<TR>
					...
					<tr> 
					  <td> 
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr> 
							<td class=th-a > 
							  <div align="center">No Users To Display.</div>
							</td>
						  </tr>
						</table>
					  </td>
	...
	?>
          <TABLE width="100%" border=1 cellSpacing=0 class=t-a>
            <!--DWLayoutTable-->
              <TR class=th-a> 
				...
				<TD width="7%" align="left" nowrap="nowrap">User ID</TD>
				<TD width="50%" nowrap="nowrap" align="center">User Name</TD>
				<TD width="20%" nowrap="nowrap" align="center">Sponser</TD>
				<TD nowrap="nowrap" align="left">Registration Date</TD>
		...
		?>		
              <TR class=th-a> 
			  	<td colspan="6" align="right">Total Registered Users :<?=$total;?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			  </TR>
		 </TABLE>
		  <?
			if($PageNo>1)
			{
			  $PrevPageNo = $PageNo-1;
		  ?>
		  <A class='paging' href="registrationreport.php?pgno=<?=$PrevPageNo;?>&<?=$urldata;?>">&lt; P&aacute;gina Anterior</A>
		  <?
		   }
		  ?> &nbsp;&nbsp;&nbsp;
		  <?php
			if($PageNo<$totalpage)
			{
			 $NextPageNo = 	$PageNo + 1;
		  ?>
		  <A class='paging' id='next' href="registrationreport.php?pgno=<?=$NextPageNo;?>&<?=$urldata;?>">Pr&amp;oacute;xima P&amp;aacute;gina &gt;</A>
		  <?
		   }
		  ?>
	<?
